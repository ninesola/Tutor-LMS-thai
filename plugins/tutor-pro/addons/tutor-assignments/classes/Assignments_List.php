...
class Assignments_List extends \Tutor_List_Table {
	...
	function column_action($item){
		...
		echo '<a data-assignment_id="'. $item->comment_ID.'" data-assignment_action="delete" data-warning_message="'. __('Sure to delete the assignment? Attached files also will be deleted.', 'tutor-pro').'" href="#" class="tutor-assignment-action button button-delete" data-toast_success_message="'.__('Deleted', 'tutor-pro').'">'.__(' Delete', 'tutor-pro').'</a>';
	}
